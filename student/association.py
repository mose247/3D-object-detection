...
class Association:
    ...
    def gating(self, MHD, sensor): 
        ...
        if MHD <= chi2.ppf(0.95, df=sensor.dim_meas):
            return True
        else:
            return False  
    ...
    def MHD(self, track, meas):
        ...
        H = meas.sensor.get_H(track.x)          # measurement Jacobian evaluated in x
        gamma = meas.z - H*track.x              # residual
        S = H*track.P*H.transpose() + meas.R    # residual covariance
